namespace ScrollbarTest
{
    ...
    public partial class MyTreeList : Control
    {
        #region Fields
        ...
        {
            if (ClientRectangle.Width - vScrollBar1.Width >= RectWidth + 1) //Adding 1 that is width of the rectangle.
            ...
            if (ClientRectangle.Height - hScrollBar1.Height >= RectHeight + 1) //Adding 1 that is width of the rectangle.
